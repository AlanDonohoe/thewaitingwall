$(function() {
  ...
  $(".the-who-link").click(function() {
    $("#main-content").replaceWith("<div id=\"main-content\"><h3>The Who?</h3><p>We were inspired by Alain de Botton's excellent book: Religion for Atheists and moved by digital artist Witchoria's beautiful pieces on the different stages of grief. As a backdrop, we used photos taken of Brighton whilst battered by a storm or when enveloped in a fog from the sea.</p><br/><p>We, Free The Trees, have paired up with leading mental health charities to create a secular version of The Wailing Wall envisioned by Alain de Botton.</p><br/><p>Learn more: <a href=\"http://freethetrees.co.uk/\">Free The Trees</a> / <a href=\"http://alaindebotton.com/religion\">Religion for Atheists</a> / <a href=\"https://ello.co/witchoria/post/DBs5UxirltuGyR1RrKL_Zw\">Witchoria: Different Stages of Grief </a></p></div>");
  });
});